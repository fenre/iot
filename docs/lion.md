...
Find the [Lion User Guide here](lion_guide.pdf)

Find the [schematics for Lion here](lion_schematics.pdf)
...
You will need the Arduino IDE, and a package file that can be [downloaded from here.](RN2483FirmwareUpdater.zip)
